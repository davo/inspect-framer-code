;(function(d) {
  ...
  b.onreadystatechange = function() {
    ...
    if (b.readyState == 4) {
      ...
      f.setAttribute(
        'src',
        'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.10.1/min/vs/loader.js?v=Math.random()'
      )

      var enls = d.createElement('script')
      enls.setAttribute(
        'src',
        'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.10.1/min/vs/editor/editor.main.nls.js?v=Math.random()'
      )

      var e = d.createElement('script')
      e.setAttribute(
        'src',
        'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.10.1/min/vs/editor/editor.main.js?v=Math.random()'
      )
